<?php
/* Smarty version 3.1.30, created on 2019-10-20 03:03:26
  from "C:\xampp\htdocs\Licence\FR\src\view\users\evaluation\evaluer.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5dabb25e07a4e8_54229901',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e3cf0f55ea5cfbe82df3ecaedcd3aae4be500aa9' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Licence\\FR\\src\\view\\users\\evaluation\\evaluer.html',
      1 => 1571533163,
      2 => 'file',
    ),
  ),
...
function content_5dabb25e07a4e8_54229901 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-7">
                                    ...
                                    <h5>Probabilité: 0  et Sévérité: 0</h5> 
                                    <h6>Mesures compensatoires</h6>
                                    <div class="form-group" style="background-color:darkgrey">
                                      <p>
                                              Les emplois qui impliquent des tâches répétitives et
                                              très spécifiques, comme ceux du secteur
                                              manufacturier, sont en déclin dans les économies
                                              plus développées. 
                                      </p>
                                    </div>
                                    <h6>Faire un commentaire</h6>
                                    <form class="forms-sample">
                                        <div class="form-group">
                                            <textarea class="form-control" name="" id="" cols="30" rows="6" placeholder="Commentaire"></textarea>
                                        </div>
                                        <a href="<?php echo $_smarty_tpl->tpl_vars['url_base']->value;?>
User/EvaluerMission2" class="btn btn-sm btn-info mr-2">Suivant</a>
                                    </form>     
                                </div>  
                                <div class="col-lg-5">
                                    <div class="form-group">
                                        <label for="exampleInputUsername1"> <i class="mdi mdi-library-plus"></i> Liste des documents</label><br>
