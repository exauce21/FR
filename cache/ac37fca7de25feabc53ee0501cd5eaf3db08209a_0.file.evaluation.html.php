<?php
/* Smarty version 3.1.30, created on 2019-10-30 16:11:43
  from "C:\xampp\htdocs\Licence\FR\src\view\users\evaluation\evaluation.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5db9a82f2de780_23448438',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'ac37fca7de25feabc53ee0501cd5eaf3db08209a' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Licence\\FR\\src\\view\\users\\evaluation\\evaluation.html',
      1 => 1572448299,
      2 => 'file',
    ),
  ),
...
function content_5db9a82f2de780_23448438 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
...
Evaluation" style="text-decoration: none; color: black;">
                                    <h4>Nom d'évaluation</h4>
                            ...
                            <td width="12%">
                                ...
                                <p class="text-danger">
                                    ...
                                    <a href="<?php echo $_smarty_tpl->tpl_vars['url_base']->value;?>
User/EvaluerMission" class="btn btn-sm btn-primary">
                                      Evaluer
                                    </a>
                                </p>
                            </td>
                    ...
                    <p>
                        ...
                        <a data-toggle="modal" data-target="#ajoutModal" class="btn btn-sm btn-primary">
                            Intéruption
                        </a>
                        <a href="<?php echo $_smarty_tpl->tpl_vars['url_base']->value;?>
User/EvaluerMission" class="btn btn-sm btn-success">
                            Incident report 
                        </a>
                        <a data-toggle="modal" data-target="#addReport" class="btn btn-sm btn-info">
                            Add risque report 
                        </a>
                    </p>
                </div>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                    ...
                    <a href="<?php echo $_smarty_tpl->tpl_vars['url_base']->value;?>
User/ListeIncident" class="btn btn-sm btn-info mr-2">Suivant</a>
                    <button class="btn btn-sm btn-danger">Cancel</button>
  ...
  <form action="">
    <div class="modal fade" id="addReport" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Description mission</h5>
                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">×</span>
                </button>
            </div>
            <div class="modal-body">
                  ...
                  <div class="form-group">
                      <label for="exampleInputUsername1">Nom du risque : </label><br>
                  </div>
                  <div class="form-group">
                      <table>
                          <thead>
                          ...
                          <tbody class="table">
                                <tr>
                                    <td>Est ce que le risque est matérialisé ?</td>
                                    <td>
                    ...
                    <div class="form-group">
                        <label for="exampleInputUsername1">Commentaires</label>
