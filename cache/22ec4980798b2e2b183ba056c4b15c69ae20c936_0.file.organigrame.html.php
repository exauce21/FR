<?php
/* Smarty version 3.1.30, created on 2019-09-11 01:54:33
  from "C:\xampp\htdocs\Licence\php\FR\src\view\supadmin\entreprise\organigrame.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5d7837b97b1aa4_02246952',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '22ec4980798b2e2b183ba056c4b15c69ae20c936' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Licence\\php\\FR\\src\\view\\supadmin\\entreprise\\organigrame.html',
      1 => 1568159504,
      2 => 'file',
    ),
  ),
...
function content_5d7837b97b1aa4_02246952 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <table class="table table-hover">
                        ...
                        <tr>
                            <td>
                                <a class="nav-link" data-toggle="collapse" href="#mission-pages" aria-expanded="false" aria-controls="mission-pages">
                                    <span class="menu-title"> <h3>Nom de l'Entreprise </h3>
                                    <p style="color: black;">
                                        <i class="mdi mdi-account-location menu-icon"></i> Adresse:  <i class="mdi mdi-message-text menu-icon"></i>Email responsable:
                                    </p> 
                                    </span>
                                  </a>
                                  <div class="collapse" id="mission-pages">
                                    <ul class="nav flex-column sub-menu">
                                      <li class="nav-item"> <a class="nav-link">User 1</a></li>
                                      <li class="nav-item"> <a class="nav-link">User 2</a></li>
                                    </ul>
                                  </div>
                            </td>
                            <td width="12%">
                        ...
                        <tr>
                            <td>
                                <a class="nav-link" data-toggle="collapse" href="#organ-pages" aria-expanded="false" aria-controls="mission-pages">
                                    <span class="menu-title"> <h3>Nom de l'Entreprise </h3>
                                    <p style="color: black;">
                                        <i class="mdi mdi-account-location menu-icon"></i> Adresse:  <i class="mdi mdi-message-text menu-icon"></i>Email responsable:
                                    </p> 
                                  ...
                                  <div class="collapse" id="organ-pages">
                                    <ul class="nav flex-column sub-menu">
                                      <li class="nav-item"> <a class="nav-link">User 1</a></li>
                                      <li class="nav-item"> <a class="nav-link">User 2</a></li>
                                    </ul>
