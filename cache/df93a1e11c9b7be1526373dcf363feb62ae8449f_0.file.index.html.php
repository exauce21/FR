<?php
/* Smarty version 3.1.30, created on 2019-08-23 14:09:17
  from "C:\xampp\htdocs\Licence\php\FigthRisk\src\view\welcome\index.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5d5fd76d024355_52026542',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'df93a1e11c9b7be1526373dcf363feb62ae8449f' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Licence\\php\\FigthRisk\\src\\view\\welcome\\index.html',
      1 => 1566562153,
      2 => 'file',
    ),
  ),
...
function content_5d5fd76d024355_52026542 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
...
public/images/logo.svg" alt="logo"/></a>
...
public/images/faces/face1.jpg" alt="image">
          ...
          <li class="nav-item nav-profile">
            <a href="#" class="nav-link">
              <div class="nav-profile-image">
                <img src="<?php echo $_smarty_tpl->tpl_vars['url_base']->value;?>
public/images/faces/face1.jpg" alt="profile">
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <img src="<?php echo $_smarty_tpl->tpl_vars['url_base']->value;?>
public/images/faces/face1.jpg" class="mr-2" alt="image">
                            David Grey
                          </td>
                          <td>
                        ...
                        <tr>
                          <td>
                            <img src="<?php echo $_smarty_tpl->tpl_vars['url_base']->value;?>
public/images/faces/face2.jpg" class="mr-2" alt="image">
                            Stella Johnson
                          </td>
                          <td>
                            High loading time
                        ...
                        <tr>
                          <td>
                            <img src="<?php echo $_smarty_tpl->tpl_vars['url_base']->value;?>
public/images/faces/face3.jpg" class="mr-2" alt="image">
                            Marina Michel
                          </td>
                          <td>
                        ...
                        <tr>
                          <td>
                            <img src="<?php echo $_smarty_tpl->tpl_vars['url_base']->value;?>
public/images/faces/face4.jpg" class="mr-2" alt="image">
                            John Doe
                          </td>
                          <td>
                ...
                <div class="card-body">
                  ...
                  <div class="row mt-3">
                    <div class="col-6 pr-1">
                      <img src="<?php echo $_smarty_tpl->tpl_vars['url_base']->value;?>
public/images/dashboard/img_1.jpg" class="mb-2 mw-100 w-100 rounded" alt="image">
                      <img src="<?php echo $_smarty_tpl->tpl_vars['url_base']->value;?>
public/images/dashboard/img_4.jpg" class="mw-100 w-100 rounded" alt="image">
                    </div>
                    <div class="col-6 pl-1">
                      <img src="<?php echo $_smarty_tpl->tpl_vars['url_base']->value;?>
public/images/dashboard/img_2.jpg" class="mb-2 mw-100 w-100 rounded" alt="image">
                      <img src="<?php echo $_smarty_tpl->tpl_vars['url_base']->value;?>
public/images/dashboard/img_3.jpg" class="mw-100 w-100 rounded" alt="image">
                    </div>
                  </div>
                  <div class="d-flex mt-5 align-items-top">
                    <img src="<?php echo $_smarty_tpl->tpl_vars['url_base']->value;?>
public/images/faces/face3.jpg" class="img-sm rounded-circle mr-3" alt="image">
...
>
  ...
  <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['url_base']->value;?>
public/js/dashboard.js"><?php echo '</script'; ?>
>
