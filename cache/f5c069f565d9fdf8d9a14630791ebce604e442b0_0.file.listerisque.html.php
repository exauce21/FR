<?php
/* Smarty version 3.1.30, created on 2019-09-06 15:05:44
  from "C:\xampp\htdocs\Licence\php\FigthRisk\src\view\users\listerisque.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5d7259a8d07b16_91612520',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f5c069f565d9fdf8d9a14630791ebce604e442b0' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Licence\\php\\FigthRisk\\src\\view\\users\\listerisque.html',
      1 => 1567775139,
      2 => 'file',
    ),
  ),
...
function content_5d7259a8d07b16_91612520 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Risque</h5>
            ...
            <form class="forms-sample">
                <div class="form-group">
                    <div class="form-control" style="height: 60px;">
                        <label for="exampleInputUsername1">Transport matériels & Equipements radio (Aller/Retour)</label>
                    </div>
                </div>
                <div class="form-group">
                    <label for="exampleInputUsername1">Etats des infrastructures routières locales</label>
                    <label for="exampleInputUsername1">Evaluation Risque Résiduel </label>
                </div>
                <div class="form-group">
                    <label for="exampleInputUsername1">Mesures compensatoires</label>
                    <textarea class="form-control" name="" id="" cols="30" rows="5" placeholder="Solution"></textarea>
                </div>
                <div class="form-group">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="forms-sample">
                ...
                <div class="form-group">
                    <label for="exampleInputUsername1">Probabilité</label>
                ...
                <div class="form-group">
                    <label for="exampleInputUsername1">Sévérité</label>
                      <select class="form-control">
                        <option>1</option>
                        <option>2</option>
                        <option>3</option>
                ...
                <button class="btn btn-sm btn-info mr-2">Suivant</button>
                <button class="btn btn-sm  btn-danger">Cancel</button>
            </form>
          </div>
        </div>
