<?php
/* Smarty version 3.1.30, created on 2019-10-10 04:27:17
  from "C:\xampp\htdocs\Licence\FR-master_2\src\view\supadmin\entreprise\demandecreation.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5d9e97052c3e21_31727184',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2cd1b03be94c229b10a784d1b1c9052cf7cf06a3' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Licence\\FR-master_2\\src\\view\\supadmin\\entreprise\\demandecreation.html',
      1 => 1570674370,
      2 => 'file',
    ),
  ),
...
function content_5d9e97052c3e21_31727184 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <div class="row mt-3"> 
                    <div class="col-9">
                        <a data-toggle="modal" data-target="#ajoutModal" class="btn btn-sm btn-info">
...
Mission/Mission" style="text-decoration: none; color: black;">
                                    <h4>Nom de compagnie</h4>
                                    <p>Nom Prenom Email Tel Adresse</p>
                                </a>
                            </td>
                            <td width="20%">
                                ...
                                <p class="text-danger">
                                    <button class="btn btn-sm btn-primary">
                                        <i class="mdi mdi-delete"></i> Rejeter
                                    </button>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="forms-sample">
                ...
                <div class="form-group">
                    <label for="exampleInputUsername1">Nom de l'entreprise</label>
                ...
                <div class="form-group">
                    <label for="exampleInputEmail1">Email d'administrateur</label>
                    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Email">
                </div>   
                <div class="form-group">
                  <label for="exampleInputUsername1">Sous admins</label>
                  <select class="form-control" name="" id="">
                    
                  </select>
                </div> 
                <button class="btn btn-inverse-info mr-2">Submit</button>
