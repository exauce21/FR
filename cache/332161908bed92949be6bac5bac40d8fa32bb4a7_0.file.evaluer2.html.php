<?php
/* Smarty version 3.1.30, created on 2019-10-26 00:18:48
  from "C:\xampp\htdocs\Licence\FR\src\view\users\mission\evaluer2.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5db374c8afa7c8_25576008',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '332161908bed92949be6bac5bac40d8fa32bb4a7' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Licence\\FR\\src\\view\\users\\mission\\evaluer2.html',
      1 => 1571670930,
      2 => 'file',
    ),
  ),
...
function content_5db374c8afa7c8_25576008 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-7">
                                    ...
                                    <div class="form-group" style="background-color: #7AE5B3">
                                        <p>
...
User/Verification">
                                <div class="col-lg-5">
                                   <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <select class="form-control" name="Severite">
                                            <option value="1">1</option>
                                            <option value="2">2</option>
                                            <option value="3">3</option>
                                            <option value="4">4</option>
                                ...
                                <div class="col-lg-12">
                                    <a href="" class="btn btn-sm btn-primary mr-2">Précedent</a>
                                    <button class="btn btn-sm btn-facebook auth-form-btn">
                                        Suivant
                                    </button>
                                </div>
