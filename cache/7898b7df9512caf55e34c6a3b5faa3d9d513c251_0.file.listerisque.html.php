<?php
/* Smarty version 3.1.30, created on 2019-10-10 04:23:33
  from "C:\xampp\htdocs\Licence\FR-master_2\src\view\supadmin\risque\listerisque.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5d9e9625649949_79606868',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '7898b7df9512caf55e34c6a3b5faa3d9d513c251' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Licence\\FR-master_2\\src\\view\\supadmin\\risque\\listerisque.html',
      1 => 1570674208,
      2 => 'file',
    ),
  ),
...
function content_5d9e9625649949_79606868 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Ajouter un risque</h5>
          ...
          <div class="modal-body">
            <form class="forms-sample">
                ...
                <div class="form-group">
                    <label for="exampleInputUsername1">Risque initial</label>
                    <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Risque initial">
                </div>
               
                <div class="form-group">
                    <label for="exampleInputUsername1">Solution</label>
                    <textarea class="form-control" name="" id="" cols="30" rows="5" placeholder="Solution"></textarea>
                </div>

                <div class="form-group">
                    <label for="exampleInputUsername1">Délivrable</label>
                    <select class="form-control">
                        <option>Non</option>
                        <option>Oui</option>
                      </select>
                ...
                <button class="btn btn-sm btn-info mr-2">Envoyer</button>
