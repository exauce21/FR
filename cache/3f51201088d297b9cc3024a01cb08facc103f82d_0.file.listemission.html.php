<?php
/* Smarty version 3.1.30, created on 2019-10-23 14:42:00
  from "C:\xampp\htdocs\Licence\FR\src\view\users\mission\listemission.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5db04a98db4fa3_35178275',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3f51201088d297b9cc3024a01cb08facc103f82d' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Licence\\FR\\src\\view\\users\\mission\\listemission.html',
      1 => 1571834511,
      2 => 'file',
    ),
  ),
...
function content_5db04a98db4fa3_35178275 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
...
User/Mission" style="text-decoration: none; color: black;">
  ...
  <!-- Ajout Modal-->
  <form method="POST" id="formulaire" action="<?php echo $_smarty_tpl->tpl_vars['url_base']->value;?>
User/Sitemission">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
                <div class="form-group">
                    ...
                    <input name="compagnie" type="text" class="form-control" id="exampleInputUsername1" placeholder="Compagnie">
                </div>
                <div class="form-group">
                    <label for="exampleInputUsername1">Nom de la mission</label>
                    <input name="nommission" type="text" class="form-control" id="exampleInputUsername1" placeholder="Nom">
                </div>
                <div class="form-group">
                    <label for="exampleInputUsername1">Nom du responsable</label>
                    <input name="responsable" type="text" class="form-control" id="exampleInputUsername1" placeholder="Nom">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input name="duree" type="email" class="form-control" id="exampleInputUsername1" placeholder="Durée">
                </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                  ...
                  <div class="form-group">
                      ...
                      <input name="datecreation" type="date" class="form-control" id="exampleInputUsername1">
                  </div>
                  <div class="form-group">
                      <label for="exampleInputUsername1">Date début</label>
                      <input name="datedeb" type="date" class="form-control" id="exampleInputUsername1">
                  </div>
                  <div class="form-group">
                      <label for="exampleInputUsername1">Date fin</label>
                      <input name="datefin" type="date" class="form-control" id="exampleInputUsername1">
                  </div>
                  <div class="form-group">
                      <label for="exampleInputUsername1">Nombre de participants</label>
                      <select class="form-control" name="nbparticipant" id="">
                  ...
                  <div class="form-group">
                      ...
                      <select class="form-control" name="nbsite" id="">
                        <option value="1">1</option>
                        <option value="2">2</option>
                        <option value="3">3</option>
                      </select>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
                <div class="form-group">
                    ...
                    <input name="nom" type="text" class="form-control" id="exampleInputUsername1"  placeholder="Nom">
                </div>
                <div class="form-group">
                    <label for="exampleInputUsername1">Prenom</label>
                    <input name="prenom" type="text" class="form-control" id="exampleInputUsername1"  placeholder="Prenom">
                </div>
                <div class="form-group">
                    <label for="exampleInputUsername1">Tel</label>
                    <input name="tel" type="text" class="form-control" id="exampleInputUsername1"  placeholder="Tel">
                </div>
                <div class="form-group">
                    <label for="exampleInputUsername1">Email</label>
                    <input name="email" type="email" class="form-control" id="exampleInputUsername1"  placeholder="Email">
                </div>
